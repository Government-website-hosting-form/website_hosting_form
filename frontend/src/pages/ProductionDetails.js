...
function ProductionDetails() {
    ...
    useEffect(() => {
        async function loadExisting() {
            ...
            try {
                const data = await apiGet(`/infra/${ids.infraId}/servers?environment=production`);
                if (data) {
                ...
                console.error("Could not load saved production servers:", err);
            }
        }
        loadExisting();
    }, [ids.infraId]);
    ...
    async function Nextpage() {
        ...
        try {
            ...
            console.error(err);
            setError("Could not save Production Server Details.");
        } finally {
            setSaving(false);
        }
    }
    ...
    return (
        <Layout>
            <div className="form-container">
                <h2 className="section-heading">Production Server Requirements (Annexure-5B)</h2>
